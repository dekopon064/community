-- Close a current-revision content_review as non_target when a human rejects
-- it with insufficient_evidence. Same revision stays closed. A new revision
-- does not inherit the decision.
-- Reuses ingest_review_decisions and public.resolve_ingest_review_decision.
-- No new table, column, or public RPC. Do not apply without a separate approval.
-- Non-destructive rollback:
--   supabase/rollback/20260924000000_ingest_content_review_close_down.sql
